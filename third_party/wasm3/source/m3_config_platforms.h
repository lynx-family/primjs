...
// Workaround for Cosmopolitan noinline conflict:
// https://github.com/jart/cosmopolitan/issues/310
#if defined(noinline)
...
#if defined(ARDUINO) || defined(PARTICLE) || defined(PLATFORMIO) || \
    defined(__MBED__) || defined(ESP8266) || defined(ESP32) ||      \
