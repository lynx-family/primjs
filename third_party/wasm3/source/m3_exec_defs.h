...
#define m3MemInfo(mem) (((M3MemoryHeader*)(mem))->moduleList->module->memory)
#define m3MemRuntime(mem) \
  (((M3MemoryHeader*)(mem))->moduleList->module->runtime)
...
d_m3RetSig RunCode(d_m3OpSig) { nextOpDirect(); }
