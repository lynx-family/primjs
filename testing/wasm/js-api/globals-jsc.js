...
TestExported(kWasmI32, {kind: kExprI32Const, value: 455.5}, 455);
...
//   var builder = new WasmModuleBuilder();
//   builder.addGlobal(kWasmI32);  // pad
//   builder.addGlobal(kWasmI64, false, WasmInitExpr.I64Const(1234)).exportAs("foo");
//   builder.addGlobal(kWasmI32);  // pad

//   var instance = builder.instantiate();
//   assertTrue(instance.exports.foo instanceof WebAssembly.Global);
//   assertEquals(instance.exports.foo.value, 1234);
// })();
...
function TestImportedExported(type, val, expected) {
  ...
  builder.addGlobal(kWasmI32);  // pad
  builder.addGlobal(type, false, {kind: kExprGlobalGet, value: i}).exportAs("bar");
  builder.addGlobal(kWasmI32);  // pad
...
function TestGlobalIndexSpace(type, val) {
  ...
  assertEquals(0, im);
  var def = builder.addGlobal(type, false, {kind: kExprGlobalGet, value: im});
