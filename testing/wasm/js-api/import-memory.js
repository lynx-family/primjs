...
(function TestImportExport() {
  return;
  // TODO(yang): support importing memory from an exported one.
...
(function ValidateBoundsCheck() {
  ...
  for (offset = kPageSize - 3; offset < kPageSize + 4; offset++) {
    ...
    // <Primjs change>
    // assertTraps fails because the exception message is not exactly same
    // as v8 expected.
    assertThrows(load);
  }
})();
...
// TODO(yangwenming): enable these following cases.
