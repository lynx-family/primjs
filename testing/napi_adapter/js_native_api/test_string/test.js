...
const test_string = require(`./build/export`);
...
assert.strictEqual(test_string.TestUtf8Insufficient(str1, 3), str1.slice(0, 3));
...
assert.strictEqual(test_string.TestUtf8Insufficient(str2, 3), str2.slice(0, 3));
...
assert.strictEqual(test_string.TestUtf8Insufficient(str3, 3), str3.slice(0, 3));
...
// assert.strictEqual(test_string.TestUtf8Insufficient(str4, 2), str4.slice(0, 1));
...
// assert.strictEqual(test_string.TestUtf8Insufficient(str5, 2), str5.slice(0, 1));
...
assert.strictEqual(test_string.TestUtf8Insufficient(str6, 3), str6.slice(0, 1));
