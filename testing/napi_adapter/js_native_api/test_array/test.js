...
// Portions of this file are derived from Node.js test suites (test/js-native-api, test/node-api),
// which are licensed under the MIT License. See THIRD-PARTY-NOTICES.md and licenses/nodejs.MIT for details.
...
const test_array = require(`./build/export`);
