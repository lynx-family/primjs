...
static void DeleteBeforeFinalizeFinalizer(napi_env env, void* finalize_data,
                                          void* finalize_hint) {
...
static napi_value ValidateDeleteBeforeFinalize(napi_env env,
                                               napi_callback_info info) {
  ...
  NAPI_CALL(env, napi_wrap(env, wrapObject, ref_t,
                           DeleteBeforeFinalizeFinalizer, NULL, NULL));
