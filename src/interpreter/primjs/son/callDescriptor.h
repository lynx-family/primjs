...
class CallDescriptors {
 ...
 public:
  ...
  static const CallDescriptor FastCallBcHandler(int index = -1) {
    return CallDescriptor{CallKind::kFastCall, MetaFlags::kThrow, true, false,
                          index};
  }
