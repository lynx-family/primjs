...
class CodeAssembler : public son::node::GraphBuilder {
 public:
  ...
  son::node::Node* IsLepusRefValue(son::node::Node* val) {
    auto and_val = Int64And(val, Int64Value(NOT_LEPUS_PTR_MASK));
    return Equal(and_val, Int64Value(LEPUS_TAG_LEPUS_REF));
  }
  ...
  void StoreJsPropertyVarRef(son::node::Node* obj, son::node::Node* val) {
  ...
  son::node::Node* LoadJSTopSp(son::node::Node* obj) {
    auto offset = AccessBuilder::js_top_sp_offset();
    return LoadByteOffset(son::node::MachineType::kRawType, obj, offset);
  }
  void StoreJSTopSp(son::node::Node* obj, son::node::Node* val) {
    auto offset = AccessBuilder::js_top_sp_offset();
    StoreByteOffset(son::node::MachineType::kRawType, obj, offset, val);
  }
  ...
  void StoreHeapVal(son::node::Node* sp, son::node::Node* index,
                    son::node::Node* value) {
    // write barrier?
    StoreImpl(son::node::MachineType::kInt64, sp, index, value);
  }
  ...
  void SaveValue(son::node::Node* v1) {
    ...
    StoreImpl(type, rsp, IntValue(-2), v1);
  ...
  void WriteBarrier(son::node::Node* obj, son::node::Node* offset,
