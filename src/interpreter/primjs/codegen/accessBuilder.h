...
class AccessBuilder {
 public:
  ...
  static constexpr int interpreter_frame_frame_this_obj_offset(
      bool is_debugger) {
    return size_of_stack_frame(is_debugger) +
           offsetof(QuickJsFrameStruct, this_obj);
  }

  static constexpr int interpreter_frame_frame_new_target_offset(
      bool is_debugger) {
    return size_of_stack_frame(is_debugger) +
           offsetof(QuickJsFrameStruct, new_target);
  }

  static constexpr int interpreter_frame_frame_var_refs_cache_offset(
      bool is_debugger) {
    return size_of_stack_frame(is_debugger) +
           offsetof(QuickJsFrameStruct, var_refs_cache);
  }

  static constexpr int interpreter_frame_frame_cpool_offset(bool is_debugger) {
    return size_of_stack_frame(is_debugger) +
           offsetof(QuickJsFrameStruct, cpool);
  }

  static constexpr int interpreter_frame_frame_argc_offset(bool is_debugger) {
    return size_of_stack_frame(is_debugger) +
           offsetof(QuickJsFrameStruct, argc);
  }
  static constexpr int interpreter_frame_frame_caller_argc_offset(
      bool is_debugger) {
    return size_of_stack_frame(is_debugger) +
           offsetof(QuickJsFrameStruct, caller_argc);
  }

  static constexpr int interpreter_frame_frame_last_fp_offset(
      bool is_debugger) {
    return size_of_stack_frame(is_debugger) +
           offsetof(QuickJsFrameStruct, last_fp);
  }
  static constexpr int interpreter_frame_frame_last_lr_offset(
      bool is_debugger) {
    return size_of_stack_frame(is_debugger) +
           offsetof(QuickJsFrameStruct, last_lr);
  }
  ...
  static constexpr int js_property_var_ref_offset() {
    return offsetof(JSProperty, u.var_ref);
  }
  ...
  static constexpr int js_top_sp_offset() {
    return offsetof(LEPUSContext, top_sp);
  }
  ...
  static constexpr int js_stack_offset() {
    return offsetof(LEPUSContext, stack);
  }
