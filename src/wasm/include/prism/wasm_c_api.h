...
// This is official WebAssembly C
// API.(https://github.com/WebAssembly/wasm-c-api/blob/main/include/wasm.h)
...
#define WASM_DECLARE_VEC(name, ptr_or_none)                                 \
  typedef struct wasm_##name##_vec_t {                                      \
    ...
    wasm_##name##_t ptr_or_none* data;                                      \
                                                                            ...
                                                                            \
  WASM_API_EXTERN void wasm_##name##_vec_new_empty(                         \
...
static inline void wasm_name_new_from_string_nt(own wasm_name_t* out,
                                                const char* s) {
...
// WASM_API_EXTERN own wasm_engine_t* wasm_engine_new_with_config(own
// wasm_config_t*);
...
#define WASM_DECLARE_TYPE(name)                            \
  ...
  WASM_DECLARE_VEC(name, *)                                \
                                                           \
  WASM_API_EXTERN own wasm_##name##_t* wasm_##name##_copy( \
      const wasm_##name##_t*);
...
WASM_API_EXTERN const wasm_valtype_vec_t* wasm_functype_params(
    const wasm_functype_t*);
WASM_API_EXTERN const wasm_valtype_vec_t* wasm_functype_results(
    const wasm_functype_t*);
...
WASM_API_EXTERN own wasm_globaltype_t* wasm_globaltype_new(own wasm_valtype_t*,
                                                           wasm_mutability_t);

WASM_API_EXTERN const wasm_valtype_t* wasm_globaltype_content(
    const wasm_globaltype_t*);
WASM_API_EXTERN wasm_mutability_t
...
WASM_API_EXTERN own wasm_tabletype_t* wasm_tabletype_new(own wasm_valtype_t*,
                                                         const wasm_limits_t*);

WASM_API_EXTERN const wasm_valtype_t* wasm_tabletype_element(
    const wasm_tabletype_t*);
WASM_API_EXTERN const wasm_limits_t* wasm_tabletype_limits(
    const wasm_tabletype_t*);
...
WASM_API_EXTERN const wasm_limits_t* wasm_memorytype_limits(
...
WASM_API_EXTERN wasm_externkind_t
wasm_externtype_kind(const wasm_externtype_t*);

WASM_API_EXTERN wasm_externtype_t* wasm_functype_as_externtype(
    wasm_functype_t*);
WASM_API_EXTERN wasm_externtype_t* wasm_globaltype_as_externtype(
    wasm_globaltype_t*);
WASM_API_EXTERN wasm_externtype_t* wasm_tabletype_as_externtype(
    wasm_tabletype_t*);
WASM_API_EXTERN wasm_externtype_t* wasm_memorytype_as_externtype(
    wasm_memorytype_t*);

WASM_API_EXTERN wasm_functype_t* wasm_externtype_as_functype(
    wasm_externtype_t*);
WASM_API_EXTERN wasm_globaltype_t* wasm_externtype_as_globaltype(
    wasm_externtype_t*);
WASM_API_EXTERN wasm_tabletype_t* wasm_externtype_as_tabletype(
    wasm_externtype_t*);
WASM_API_EXTERN wasm_memorytype_t* wasm_externtype_as_memorytype(
    wasm_externtype_t*);

WASM_API_EXTERN const wasm_externtype_t* wasm_functype_as_externtype_const(
    const wasm_functype_t*);
...
WASM_API_EXTERN const wasm_functype_t* wasm_externtype_as_functype_const(
...
WASM_API_EXTERN const wasm_name_t* wasm_importtype_module(
    const wasm_importtype_t*);
WASM_API_EXTERN const wasm_name_t* wasm_importtype_name(
    const wasm_importtype_t*);
WASM_API_EXTERN const wasm_externtype_t* wasm_importtype_type(
    const wasm_importtype_t*);
...
WASM_API_EXTERN const wasm_name_t* wasm_exporttype_name(
    const wasm_exporttype_t*);
WASM_API_EXTERN const wasm_externtype_t* wasm_exporttype_type(
    const wasm_exporttype_t*);
...
#define WASM_DECLARE_REF_BASE(name)                                          \
  ...
  WASM_API_EXTERN own wasm_##name##_t* wasm_##name##_copy(                   \
      const wasm_##name##_t*);                                               \
  WASM_API_EXTERN bool wasm_##name##_same(const wasm_##name##_t*,            \
                                          const wasm_##name##_t*);           \
                                                                             \
...
#define WASM_DECLARE_REF(name)                                        \
  ...
  WASM_API_EXTERN const wasm_ref_t* wasm_##name##_as_ref_const(       \
      const wasm_##name##_t*);                                        \
  WASM_API_EXTERN const wasm_##name##_t* wasm_ref_as_##name##_const(  \
      const wasm_ref_t*);
...
#define WASM_DECLARE_SHARABLE_REF(name)                            \
  ...
  WASM_DECLARE_OWN(shared_##name)                                  \
                                                                   \
  WASM_API_EXTERN own wasm_shared_##name##_t* wasm_##name##_share( \
      const wasm_##name##_t*);                                     \
  WASM_API_EXTERN own wasm_##name##_t* wasm_##name##_obtain(       \
...
WASM_API_EXTERN struct wasm_instance_t* wasm_frame_instance(const
wasm_frame_t*); WASM_API_EXTERN uint32_t wasm_frame_func_index(const
wasm_frame_t*); WASM_API_EXTERN size_t wasm_frame_func_offset(const
wasm_frame_t*); WASM_API_EXTERN size_t wasm_frame_module_offset(const
wasm_frame_t*);
*/
...
WASM_API_EXTERN own wasm_trap_t* wasm_trap_new(wasm_store_t* store,
                                               const wasm_message_t*);

WASM_API_EXTERN void wasm_trap_message(const wasm_trap_t*,
                                       own wasm_message_t* out);
// WASM_API_EXTERN own wasm_frame_t* wasm_trap_origin(const wasm_trap_t*);
// WASM_API_EXTERN void wasm_trap_trace(const wasm_trap_t*, own
...
// WASM_API_EXTERN bool wasm_module_validate(wasm_store_t*, const
// wasm_byte_vec_t* binary);

WASM_API_EXTERN void wasm_module_imports(const wasm_module_t*,
                                         own wasm_importtype_vec_t* out);
WASM_API_EXTERN void wasm_module_exports(const wasm_module_t*,
                                         own wasm_exporttype_vec_t* out);

// WASM_API_EXTERN void wasm_module_serialize(const wasm_module_t*, own
// wasm_byte_vec_t* out); WASM_API_EXTERN own wasm_module_t*
// wasm_module_deserialize(wasm_store_t*, const wasm_byte_vec_t*);
...
WASM_API_EXTERN own wasm_func_t* wasm_func_new(wasm_store_t*,
                                               const wasm_functype_t*,
...
WASM_API_EXTERN own wasm_trap_t* wasm_func_call(const wasm_func_t*,
...
WASM_API_EXTERN own wasm_global_t* wasm_global_new(wasm_store_t*,
                                                   const wasm_globaltype_t*,
                                                   const wasm_val_t*);
...
WASM_API_EXTERN own wasm_table_t* wasm_table_new(wasm_store_t*,
                                                 const wasm_tabletype_t*,
                                                 wasm_ref_t* init);

WASM_API_EXTERN own wasm_tabletype_t* wasm_table_type(const wasm_table_t*);

WASM_API_EXTERN own wasm_ref_t* wasm_table_get(const wasm_table_t*,
                                               wasm_table_size_t index);
WASM_API_EXTERN bool wasm_table_set(wasm_table_t*, wasm_table_size_t index,
                                    wasm_ref_t*);

WASM_API_EXTERN wasm_table_size_t wasm_table_size(const wasm_table_t*);
WASM_API_EXTERN bool wasm_table_grow(wasm_table_t*, wasm_table_size_t delta,
                                     wasm_ref_t* init);
...
WASM_API_EXTERN own wasm_memory_t* wasm_memory_new(wasm_store_t*,
                                                   const wasm_memorytype_t*);
...
WASM_API_EXTERN wasm_memory_t* wasm_import_memory_new(uint32_t, uint32_t);
WASM_API_EXTERN void wasm_import_memory_delete(wasm_memory_t*);
WASM_API_EXTERN wasm_memory_pages_t wasm_memory_size(const wasm_memory_t*);
WASM_API_EXTERN bool wasm_memory_grow(wasm_memory_t*,
...
WASM_API_EXTERN const wasm_extern_t* wasm_func_as_extern_const(
    const wasm_func_t*);
WASM_API_EXTERN const wasm_extern_t* wasm_global_as_extern_const(
    const wasm_global_t*);
WASM_API_EXTERN const wasm_extern_t* wasm_table_as_extern_const(
    const wasm_table_t*);
WASM_API_EXTERN const wasm_extern_t* wasm_memory_as_extern_const(
    const wasm_memory_t*);

WASM_API_EXTERN const wasm_func_t* wasm_extern_as_func_const(
    const wasm_extern_t*);
WASM_API_EXTERN const wasm_global_t* wasm_extern_as_global_const(
    const wasm_extern_t*);
WASM_API_EXTERN const wasm_table_t* wasm_extern_as_table_const(
    const wasm_extern_t*);
WASM_API_EXTERN const wasm_memory_t* wasm_extern_as_memory_const(
    const wasm_extern_t*);
...
WASM_API_EXTERN own wasm_instance_t* wasm_instance_new_with_args(
    wasm_store_t*, const wasm_module_t*, const wasm_extern_vec_t* imports,
    own wasm_trap_t** trap, const uint32_t stack_size,
    const uint32_t heap_size);

WASM_API_EXTERN void wasm_instance_exports(const wasm_instance_t*,
...
static inline own wasm_functype_t* wasm_functype_new_2_2(
    own wasm_valtype_t* p1, own wasm_valtype_t* p2, own wasm_valtype_t* r1,
