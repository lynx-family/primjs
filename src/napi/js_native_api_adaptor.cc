...
#include "js_native_api_adaptor.h"
...
#include "napi/env/napi_runtime_internal.h"
...
napi_status napi_call_threadsafe_function_primjs(
  ...
  return napi_call_threadsafe_function_internal(func, data, is_blocking);
}

napi_status napi_release_threadsafe_function_primjs(
    napi_threadsafe_function func) {
  return napi_delete_threadsafe_function_internal(func);
}

napi_status napi_get_threadsafe_function_context_primjs(
    napi_threadsafe_function func, void** result) {
  return napi_get_threadsafe_function_context_internal(func, result);
}
...
napi_status napi_create_bigint_int64_primjs(napi_env env, int64_t value,
                                            napi_value* result) {
  // TODO: Add BigInt support and remove those hacky code.
  return env->napi_create_int64(env, value, result);
}
napi_status napi_create_bigint_uint64_primjs(napi_env env, uint64_t value,
                                             napi_value* result) {
  // TODO: Add BigInt support and remove those hacky code.
  return env->napi_create_int64(env, static_cast<int64_t>(value), result);
}
...
napi_status napi_get_value_bigint_uint64_primjs(napi_env env, napi_value value,
  ...
  napi_status status = env->napi_get_value_int64(env, value, &result_int64);
  *result = static_cast<uint64_t>(result_int64);
  return status;
}
