#ifndef WEAK_NODE_API_SRC_NAPI_INL_H_
#define WEAK_NODE_API_SRC_NAPI_INL_H_
...
inline napi_status AttachData(napi_env env, napi_value obj, FreeType* data,
                              void* hint = nullptr) {
  napi_status status;
#if (NAPI_VERSION < 5)
  ...
  if (status == napi_ok) {
    ...
    if (status == napi_ok) {
      napi_property_descriptor desc = {nullptr,      symbol,  nullptr,
...
struct FinalizeData {
  static inline void Wrapper(napi_env env, void* data,
  ...
  static inline void WrapperWithHint(napi_env env, void* data,
                                     void* finalizeHint) NAPI_NOEXCEPT {
    WrapVoidCallback([&] {
      FinalizeData* finalizeData = static_cast<FinalizeData*>(finalizeHint);
      finalizeData->callback(Env(env), static_cast<T*>(data),
...
struct ThreadSafeFinalize {
  static inline void Wrapper(napi_env env, void* rawFinalizeData,
                             void* /* rawContext */) {
...
template <typename ContextType, typename DataType, typename CallJs, CallJs call>
inline typename std::enable_if<call == static_cast<CallJs>(nullptr)>::type
CallJsWrapper(napi_env env, napi_value jsCallback, void* /*context*/,
              void* /*data*/) {
  details::WrapVoidCallback([&]() {
...
inline napi_value RegisterModule(napi_env env, napi_value exports,
...
inline MaybeOrValue<Value> Env::RunScript(String script) const {
  ...
  NAPI_RETURN_OR_THROW_IF_FAILED(_env, status, Napi::Value(_env, result),
                                 Napi::Value);
}
...
inline bool Value::IsEmpty() const { return _value == nullptr; }
...
inline bool Value::IsUndefined() const { return Type() == napi_undefined; }

inline bool Value::IsNull() const { return Type() == napi_null; }

inline bool Value::IsBoolean() const { return Type() == napi_boolean; }

inline bool Value::IsNumber() const { return Type() == napi_number; }

#if NAPI_VERSION > 5
inline bool Value::IsBigInt() const { return Type() == napi_bigint; }
#endif  // NAPI_VERSION > 5
...
inline bool Value::IsString() const { return Type() == napi_string; }

inline bool Value::IsSymbol() const { return Type() == napi_symbol; }
...
inline bool Value::IsFunction() const { return Type() == napi_function; }
...
inline bool Value::IsExternal() const { return Type() == napi_external; }
...
inline MaybeOrValue<Boolean> Value::ToBoolean() const {
  ...
  NAPI_RETURN_OR_THROW_IF_FAILED(_env, status, Napi::Boolean(_env, result),
                                 Napi::Boolean);
}
...
inline MaybeOrValue<Number> Value::ToNumber() const {
  ...
  NAPI_RETURN_OR_THROW_IF_FAILED(_env, status, Napi::Number(_env, result),
                                 Napi::Number);
}
...
inline MaybeOrValue<String> Value::ToString() const {
  ...
  NAPI_RETURN_OR_THROW_IF_FAILED(_env, status, Napi::String(_env, result),
                                 Napi::String);
}
...
inline MaybeOrValue<Object> Value::ToObject() const {
  ...
  NAPI_RETURN_OR_THROW_IF_FAILED(_env, status, Napi::Object(_env, result),
                                 Napi::Object);
}
...
inline void Boolean::CheckCast(napi_env env, napi_value value) {
  ...
  NAPI_CHECK(type == napi_boolean, "Boolean::CheckCast",
             "value is not napi_boolean");
}
...
inline Boolean::operator bool() const { return Value(); }
...
inline void Number::CheckCast(napi_env env, napi_value value) {
  ...
  NAPI_CHECK(type == napi_number, "Number::CheckCast",
             "value is not napi_number");
}
...
inline Number::operator uint32_t() const { return Uint32Value(); }

inline Number::operator int64_t() const { return Int64Value(); }

inline Number::operator float() const { return FloatValue(); }

inline Number::operator double() const { return DoubleValue(); }
...
inline BigInt BigInt::New(napi_env env, int sign_bit, size_t word_count,
...
inline void BigInt::CheckCast(napi_env env, napi_value value) {
  ...
  NAPI_CHECK(type == napi_bigint, "BigInt::CheckCast",
             "value is not napi_bigint");
}
...
inline void BigInt::ToWords(int* sign_bit, size_t* word_count,
                            uint64_t* words) {
  napi_status status =
...
inline Date::operator double() const { return ValueOf(); }
...
inline void Name::CheckCast(napi_env env, napi_value value) {
  ...
  NAPI_CHECK(type == napi_string || type == napi_symbol, "Name::CheckCast",
...
inline void String::CheckCast(napi_env env, napi_value value) {
  ...
  NAPI_CHECK(type == napi_string, "String::CheckCast",
...
inline String::operator std::string() const { return Utf8Value(); }

inline String::operator std::u16string() const { return Utf16Value(); }
...
inline std::string String::Utf8Value() const {
  ...
  value.resize(length);
  status = napi_get_value_string_utf8(_env, _value, &value[0], value.capacity(),
                                      nullptr);
  NAPI_THROW_IF_FAILED(_env, status, "");
  return value;
}
...
inline std::u16string String::Utf16Value() const {
  ...
  value.reserve(length + 1);
  value.resize(length);
  status = napi_get_value_string_utf16(_env, _value, &value[0],
...
inline void Symbol::CheckCast(napi_env env, napi_value value) {
  ...
  NAPI_CHECK(type == napi_symbol, "Symbol::CheckCast",
             "value is not napi_symbol");
}
...
inline void Object::CheckCast(napi_env env, napi_value value) {
  ...
  NAPI_CHECK(type == napi_object, "Object::CheckCast",
             "value is not napi_object");
}
...
inline void Object::AddFinalizer(Finalizer finalizeCallback, T* data,
  ...
  napi_status status = details::AttachData<
      T, details::FinalizeData<T, Finalizer, Hint>::WrapperWithHint>(
      _env, *this, data, finalizeData);
  if (status != napi_ok) {
    delete finalizeData;
    NAPI_THROW_IF_FAILED_VOID(_env, status);
...
inline External<T> External<T>::New(napi_env env, T* data,
  ...
  napi_status status = napi_create_external(
      env, data, details::FinalizeData<T, Finalizer>::Wrapper, finalizeData,
      &value);
  if (status != napi_ok) {
    delete finalizeData;
    NAPI_THROW_IF_FAILED(env, status, External());
...
inline External<T> External<T>::New(napi_env env, T* data,
  ...
  details::FinalizeData<T, Finalizer, Hint>* finalizeData =
      new details::FinalizeData<T, Finalizer, Hint>(
          {std::move(finalizeCallback), finalizeHint});
  napi_status status = napi_create_external(
      env, data, details::FinalizeData<T, Finalizer, Hint>::WrapperWithHint,
      finalizeData, &value);
  if (status != napi_ok) {
    delete finalizeData;
    NAPI_THROW_IF_FAILED(env, status, External());
...
inline void External<T>::CheckCast(napi_env env, napi_value value) {
  ...
  NAPI_CHECK(type == napi_external, "External::CheckCast",
...
inline ArrayBuffer ArrayBuffer::New(napi_env env, void* externalData,
                                    size_t byteLength) {
  napi_value value;
...
inline ArrayBuffer ArrayBuffer::New(napi_env env, void* externalData,
  ...
  details::FinalizeData<void, Finalizer>* finalizeData =
      new details::FinalizeData<void, Finalizer>(
          {std::move(finalizeCallback), nullptr});
  napi_status status = napi_create_external_arraybuffer(
      env, externalData, byteLength,
      details::FinalizeData<void, Finalizer>::Wrapper, finalizeData, &value);
  if (status != napi_ok) {
    delete finalizeData;
    NAPI_THROW_IF_FAILED(env, status, ArrayBuffer());
  }
...
inline void ArrayBuffer::CheckCast(napi_env env, napi_value value) {
  ...
  NAPI_CHECK(status == napi_ok, "ArrayBuffer::CheckCast",
...
inline void DataView::CheckCast(napi_env env, napi_value value) {
  ...
  NAPI_CHECK(status == napi_ok, "DataView::CheckCast",
             "napi_is_dataview failed");
...
inline DataView::DataView(napi_env env, napi_value value) : Object(env, value) {
  napi_status status = napi_get_dataview_info(
      _env, _value /* dataView */, &_length /* byteLength */, &_data /* data */,
      nullptr /* arrayBuffer */, nullptr /* byteOffset */);
  NAPI_THROW_IF_FAILED_VOID(_env, status);
}
...
inline Napi::ArrayBuffer DataView::ArrayBuffer() const {
  ...
  napi_status status = napi_get_dataview_info(
      _env, _value /* dataView */, nullptr /* byteLength */, nullptr /* data */,
...
inline size_t DataView::ByteLength() const { return _length; }
...
inline void TypedArray::CheckCast(napi_env env, napi_value value) {
  ...
  NAPI_CHECK(status == napi_ok, "TypedArray::CheckCast",
...
inline TypedArray::TypedArray(napi_env env, napi_value value)
  ...
  if (value != nullptr) {
    napi_status status = napi_get_typedarray_info(
        _env, _value, &const_cast<TypedArray*>(this)->_type,
        &const_cast<TypedArray*>(this)->_length, nullptr, nullptr, nullptr);
    NAPI_THROW_IF_FAILED_VOID(_env, status);
  }
}
...
inline napi_typedarray_type TypedArray::TypedArrayType() const { return _type; }
...
inline size_t TypedArray::ElementLength() const { return _length; }

inline size_t TypedArray::ByteOffset() const {
  size_t byteOffset;
  napi_status status = napi_get_typedarray_info(_env, _value, nullptr, nullptr,
                                                nullptr, nullptr, &byteOffset);
  NAPI_THROW_IF_FAILED(_env, status, 0);
  return byteOffset;
}
...
inline void TypedArrayOf<T>::CheckCast(napi_env env, napi_value value) {
  ...
  napi_status status = napi_get_typedarray_info(env, value, &type, nullptr,
                                                nullptr, nullptr, nullptr);
  NAPI_CHECK(status == napi_ok, "TypedArrayOf::CheckCast",
             "napi_is_typedarray failed");
...
template <typename T>
inline TypedArrayOf<T> TypedArrayOf<T>::New(napi_env env, size_t elementLength,
                                            napi_typedarray_type type) {
...
inline TypedArrayOf<T>::TypedArrayOf(napi_env env, napi_value value)
  ...
  if (value != nullptr) {
    void* data = nullptr;
    status = napi_get_typedarray_info(_env, _value, &_type, &_length, &data,
                                      nullptr, nullptr);
...
inline napi_status CreateFunction(napi_env env, const char* utf8name,
                                  napi_callback cb, CbData* data,
                                  napi_value* result) {
  napi_status status =
...
inline Function Function::New(napi_env env, const char* utf8name, void* data) {
  ...
  napi_status status =
      napi_create_function(env, utf8name, NAPI_AUTO_LENGTH,
                           details::TemplatedVoidCallback<cb>, data, &result);
...
inline Function Function::New(napi_env env, const char* utf8name, void* data) {
  ...
  napi_status status =
      napi_create_function(env, utf8name, NAPI_AUTO_LENGTH,
                           details::TemplatedCallback<cb>, data, &result);
  NAPI_THROW_IF_FAILED(env, status, Function());
  return Function(env, result);
}

template <Function::VoidCallback cb>
inline Function Function::New(napi_env env, const std::string& utf8name,
                              void* data) {
...
template <typename Callable>
inline Function Function::New(napi_env env, Callable cb, const char* utf8name,
                              void* data) {
...
template <typename Callable>
inline Function Function::New(napi_env env, Callable cb,
...
inline void Function::CheckCast(napi_env env, napi_value value) {
  ...
  NAPI_CHECK(type == napi_function, "Function::CheckCast",
...
inline MaybeOrValue<Value> Function::Call(napi_value recv, size_t argc,
                                          const napi_value* args) const {
  napi_value result;
  napi_status status =
...
inline MaybeOrValue<Value> Function::MakeCallback(
    napi_value recv, const std::vector<napi_value>& args,
    napi_async_context context) const {
...
inline Napi::Env Promise::Deferred::Env() const { return Napi::Env(_env); }
...
inline Buffer<T> Buffer<T>::New(napi_env env, T* data, size_t length,
  ...
  napi_status status = napi_create_external_buffer(
      ...
      details::FinalizeData<T, Finalizer>::Wrapper, finalizeData, &value);
  if (status != napi_ok) {
    delete finalizeData;
...
inline Buffer<T> Buffer<T>::New(napi_env env, T* data, size_t length,
  ...
  napi_status status = napi_create_external_buffer(
      env, length * sizeof(T), data,
      details::FinalizeData<T, Finalizer, Hint>::WrapperWithHint, finalizeData,
      &value);
  if (status != napi_ok) {
    delete finalizeData;
    NAPI_THROW_IF_FAILED(env, status, Buffer());
...
inline Buffer<T> Buffer<T>::NewOrCopy(napi_env env, T* data, size_t length,
  ...
  if (status == details::napi_no_external_buffers_allowed) {
    ...
    // If we can't create an external buffer, we'll just copy the data.
    Buffer<T> ret = Buffer<T>::Copy(env, data, length);
    details::FinalizeData<T, Finalizer, Hint>::WrapperWithHint(env, data,
                                                               finalizeData);
    return ret;
#ifndef NODE_API_NO_EXTERNAL_BUFFERS_ALLOWED
  }
...
inline Error Error::New(napi_env env) {
...

  {
    ...
    memcpy(&last_error_info_copy, last_error_info,
  ...
  if (is_exception_pending) {
    ...
    NAPI_FATAL_IF_FAILED(status, "Error::New",
    ...
    napi_value message;
    status = napi_create_string_utf8(env, error_message,
                                     std::strlen(error_message), &message);
...
inline Error Error::New(napi_env env, const char* message) {
  return Error::New<Error>(env, message, std::strlen(message),
                           napi_create_error);
}

inline Error Error::New(napi_env env, const std::string& message) {
  return Error::New<Error>(env, message.c_str(), message.size(),
                           napi_create_error);
}
    ...
    if (status != napi_ok) {
      ...
      napi_property_descriptor wrapObjFlag = {
          ERROR_WRAP_VALUE(),  // Unique GUID identifier since Symbol isn't a
                               // viable option
          nullptr, nullptr, nullptr, nullptr, Value::From(env, value),
...
inline Object Error::Value() const {
  ...
  if (type != napi_symbol) {
    ...
    status = napi_has_property(_env, refValue,
    ...
    if (isWrappedObject) {
      ...
      status = napi_get_property(_env, refValue,
                                 String::From(_env, ERROR_WRAP_VALUE()),
                                 &unwrappedValue);
      NAPI_THROW_IF_FAILED(_env, status, Object());
...
#else   // NAPI_CPP_EXCEPTIONS
    NAPI_FATAL_IF_FAILED(status, "Error::ThrowAsJavaScriptException",
                         "napi_throw");
#endif  // NAPI_CPP_EXCEPTIONS
  }
}
...
inline TError Error::New(napi_env env, const char* message, size_t length,
...
inline TypeError TypeError::New(napi_env env, const char* message) {
  return Error::New<TypeError>(env, message, std::strlen(message),
                               napi_create_type_error);
}

inline TypeError TypeError::New(napi_env env, const std::string& message) {
  return Error::New<TypeError>(env, message.c_str(), message.size(),
                               napi_create_type_error);
}
...
inline RangeError RangeError::New(napi_env env, const char* message) {
  return Error::New<RangeError>(env, message, std::strlen(message),
                                napi_create_range_error);
}

inline RangeError RangeError::New(napi_env env, const std::string& message) {
  return Error::New<RangeError>(env, message.c_str(), message.size(),
                                napi_create_range_error);
}
...
inline SyntaxError SyntaxError::New(napi_env env, const char* message) {
  return Error::New<SyntaxError>(env, message, std::strlen(message),
                                 node_api_create_syntax_error);
}

inline SyntaxError SyntaxError::New(napi_env env, const std::string& message) {
  return Error::New<SyntaxError>(env, message.c_str(), message.size(),
                                 node_api_create_syntax_error);
}
...
inline Reference<T>::Reference(const Reference<T>& other)
  ...
  if (value != nullptr) {
    ...
    // reference is weak.
    napi_status status = napi_create_reference(_env, value, 1, &_ref);
    NAPI_FATAL_IF_FAILED(status, "Reference<T>::Reference",
...
inline CallbackInfo::operator napi_callback_info() const { return _info; }
...
inline Napi::Env CallbackInfo::Env() const { return Napi::Env(_env); }

inline size_t CallbackInfo::Length() const { return _argc; }
...
inline void CallbackInfo::SetData(void* data) { _data = data; }
...
template <typename PropertyDescriptor::GetterCallback Getter>
PropertyDescriptor PropertyDescriptor::Accessor(
    const std::string& utf8name, napi_property_attributes attributes,
    void* data) {
...
inline PropertyDescriptor PropertyDescriptor::Accessor(
    Napi::Env env, Napi::Object object, const char* utf8name, Getter getter,
  ...
  return PropertyDescriptor({utf8name, nullptr, nullptr, CbData::Wrapper,
                             nullptr, nullptr, attributes, callbackData});
}

template <typename Getter>
inline PropertyDescriptor PropertyDescriptor::Accessor(
    Napi::Env env, Napi::Object object, const std::string& utf8name,
    Getter getter, napi_property_attributes attributes, void* data) {
  return Accessor(env, object, utf8name.c_str(), getter, attributes, data);
}

template <typename Getter>
inline PropertyDescriptor PropertyDescriptor::Accessor(
    Napi::Env env, Napi::Object object, Name name, Getter getter,
    napi_property_attributes attributes, void* data) {
  using CbData = details::CallbackData<Getter, Napi::Value>;
  auto callbackData = new CbData({getter, data});
  ...
  return PropertyDescriptor({nullptr, name, nullptr, CbData::Wrapper, nullptr,
                             nullptr, attributes, callbackData});
}

template <typename Getter, typename Setter>
inline PropertyDescriptor PropertyDescriptor::Accessor(
    Napi::Env env, Napi::Object object, const char* utf8name, Getter getter,
    Setter setter, napi_property_attributes attributes, void* data) {
  ...
  return PropertyDescriptor({utf8name, nullptr, nullptr, CbData::GetterWrapper,
                             CbData::SetterWrapper, nullptr, attributes,
                             callbackData});
}
...
inline PropertyDescriptor PropertyDescriptor::Accessor(
    Napi::Env env, Napi::Object object, const std::string& utf8name,
    Getter getter, Setter setter, napi_property_attributes attributes,
    void* data) {
  return Accessor(env, object, utf8name.c_str(), getter, setter, attributes,
                  data);
}

template <typename Getter, typename Setter>
inline PropertyDescriptor PropertyDescriptor::Accessor(
    Napi::Env env, Napi::Object object, Name name, Getter getter, Setter setter,
    napi_property_attributes attributes, void* data) {
  using CbData = details::AccessorCallbackData<Getter, Setter>;
  auto callbackData = new CbData({getter, setter, data});
  ...
  return PropertyDescriptor({nullptr, name, nullptr, CbData::GetterWrapper,
                             CbData::SetterWrapper, nullptr, attributes,
                             callbackData});
}
...
inline PropertyDescriptor PropertyDescriptor::Function(
    Napi::Env env, Napi::Object /*object*/, const char* utf8name, Callable cb,
    napi_property_attributes attributes, void* data) {
...
inline PropertyDescriptor PropertyDescriptor::Function(
    Napi::Env env, Napi::Object object, const std::string& utf8name,
    Callable cb, napi_property_attributes attributes, void* data) {
  return Function(env, object, utf8name.c_str(), cb, attributes, data);
}

template <typename Callable>
inline PropertyDescriptor PropertyDescriptor::Function(
    Napi::Env env, Napi::Object /*object*/, Name name, Callable cb,
    napi_property_attributes attributes, void* data) {
  return PropertyDescriptor({nullptr, name, nullptr, nullptr, nullptr,
...
inline PropertyDescriptor PropertyDescriptor::Value(
    const std::string& utf8name, napi_value value,
    napi_property_attributes attributes) {
...
inline ClassPropertyDescriptor<T> InstanceWrap<T>::InstanceMethod(
    const char* utf8name, InstanceVoidMethodCallback method,
    napi_property_attributes attributes, void* data) {
...
template <typename T>
inline ClassPropertyDescriptor<T> InstanceWrap<T>::InstanceMethod(
    const char* utf8name, InstanceMethodCallback method,
    napi_property_attributes attributes, void* data) {
...
template <typename T>
inline ClassPropertyDescriptor<T> InstanceWrap<T>::InstanceMethod(
    Symbol name, InstanceVoidMethodCallback method,
    napi_property_attributes attributes, void* data) {
  InstanceVoidMethodCallbackData* callbackData =
      new InstanceVoidMethodCallbackData({method, data});
...
template <typename T>
inline ClassPropertyDescriptor<T> InstanceWrap<T>::InstanceMethod(
    Symbol name, InstanceMethodCallback method,
    napi_property_attributes attributes, void* data) {
  InstanceMethodCallbackData* callbackData =
      new InstanceMethodCallbackData({method, data});
...
inline ClassPropertyDescriptor<T> InstanceWrap<T>::InstanceAccessor(
    const char* utf8name, InstanceGetterCallback getter,
...
template <typename T>
inline ClassPropertyDescriptor<T> InstanceWrap<T>::InstanceAccessor(
    Symbol name, InstanceGetterCallback getter, InstanceSetterCallback setter,
    napi_property_attributes attributes, void* data) {
  InstanceAccessorCallbackData* callbackData =
      new InstanceAccessorCallbackData({getter, setter, data});
...
inline ClassPropertyDescriptor<T> InstanceWrap<T>::InstanceValue(
    const char* utf8name, Napi::Value value,
    napi_property_attributes attributes) {
  napi_property_descriptor desc = napi_property_descriptor();
  desc.utf8name = utf8name;
  desc.value = value;
...
inline Function ObjectWrap<T>::DefineClass(
  ...
  for (size_t index = 0; index < props_count; index++) {
    ...
    if (prop->method == T::StaticMethodCallbackWrapper) {
      status = CreateFunction(
          env, utf8name, prop->method,
          static_cast<StaticMethodCallbackData*>(prop->data), &(prop->value));
      NAPI_THROW_IF_FAILED(env, status, Function());
      prop->method = nullptr;
      prop->data = nullptr;
    } else if (prop->method == T::StaticVoidMethodCallbackWrapper) {
      status =
          CreateFunction(env, utf8name, prop->method,
  ...
  napi_value value;
  status = napi_define_class(env, utf8name, NAPI_AUTO_LENGTH,
                             T::ConstructorCallbackWrapper, data, props_count,
                             props.data(), &value);
  NAPI_THROW_IF_FAILED(env, status, Function());
...
inline Function ObjectWrap<T>::DefineClass(
    Napi::Env env, const char* utf8name,
    const std::vector<ClassPropertyDescriptor<T>>& properties, void* data) {
  return DefineClass(
      env, utf8name, properties.size(),
      reinterpret_cast<const napi_property_descriptor*>(properties.data()),
      data);
...
inline ClassPropertyDescriptor<T> ObjectWrap<T>::StaticMethod(
    const char* utf8name, StaticVoidMethodCallback method,
    napi_property_attributes attributes, void* data) {
...
template <typename T>
inline ClassPropertyDescriptor<T> ObjectWrap<T>::StaticMethod(
    Symbol name, StaticVoidMethodCallback method,
    napi_property_attributes attributes, void* data) {
  StaticVoidMethodCallbackData* callbackData =
      new StaticVoidMethodCallbackData({method, data});
...
template <typename T>
inline ClassPropertyDescriptor<T> ObjectWrap<T>::StaticMethod(
    Symbol name, StaticMethodCallback method,
    napi_property_attributes attributes, void* data) {
  StaticMethodCallbackData* callbackData =
      new StaticMethodCallbackData({method, data});
...
inline ClassPropertyDescriptor<T> ObjectWrap<T>::StaticAccessor(
    const char* utf8name, StaticGetterCallback getter,
...
template <typename T>
inline ClassPropertyDescriptor<T> ObjectWrap<T>::StaticAccessor(
    Symbol name, StaticGetterCallback getter, StaticSetterCallback setter,
    napi_property_attributes attributes, void* data) {
  StaticAccessorCallbackData* callbackData =
      new StaticAccessorCallbackData({getter, setter, data});
...
template <typename T>
inline void ObjectWrap<T>::FinalizeCallback(napi_env env, void* data,
                                            void* /*hint*/) {
...
inline HandleScope::~HandleScope() {
  ...
  NAPI_FATAL_IF_FAILED(status, "HandleScope::~HandleScope",
                       "napi_close_handle_scope");
}

inline HandleScope::operator napi_handle_scope() const { return _scope; }

inline Napi::Env HandleScope::Env() const { return Napi::Env(_env); }
...
inline EscapableHandleScope::~EscapableHandleScope() {
  ...
  NAPI_FATAL_IF_FAILED(status, "EscapableHandleScope::~EscapableHandleScope",
...
inline Napi::Env EscapableHandleScope::Env() const { return Napi::Env(_env); }
...
inline CallbackScope::~CallbackScope() {
  ...
  NAPI_FATAL_IF_FAILED(status, "CallbackScope::~CallbackScope",
                       "napi_close_callback_scope");
}

inline CallbackScope::operator napi_callback_scope() const { return _scope; }

inline Napi::Env CallbackScope::Env() const { return Napi::Env(_env); }
#endif
...
inline AsyncContext::AsyncContext(napi_env env, const char* resource_name,
  ...
  napi_status status = napi_create_string_utf8(_env, resource_name,
                                               NAPI_AUTO_LENGTH, &resource_id);
  NAPI_THROW_IF_FAILED_VOID(_env, status);
...
inline AsyncContext::operator napi_async_context() const { return _context; }

inline Napi::Env AsyncContext::Env() const { return Napi::Env(_env); }
...
inline AsyncWorker::AsyncWorker(const Function& callback,
                                const char* resource_name,
                                const Object& resource)
    : AsyncWorker(Object::New(callback.Env()), callback, resource_name,
                  resource) {}
...
inline AsyncWorker::AsyncWorker(const Object& receiver,
                                const Function& callback,
                                const char* resource_name)
    : AsyncWorker(receiver, callback, resource_name,
...
inline AsyncWorker::AsyncWorker(const Object& receiver,
  ...
  status =
      napi_create_async_work(_env, resource, resource_id, OnAsyncWorkExecute,
...
inline void AsyncWorker::Destroy() { delete this; }

inline AsyncWorker::operator napi_async_work() const { return _work; }

inline Napi::Env AsyncWorker::Env() const { return Napi::Env(_env); }
...
inline ObjectReference& AsyncWorker::Receiver() { return _receiver; }

inline FunctionReference& AsyncWorker::Callback() { return _callback; }

inline void AsyncWorker::SuppressDestruct() { _suppress_destruct = true; }
...
inline void AsyncWorker::SetError(const std::string& error) { _error = error; }
...
inline void AsyncWorker::OnAsyncWorkComplete(napi_env env, napi_status status,
                                             void* asyncworker) {
  AsyncWorker* self = static_cast<AsyncWorker*>(asyncworker);
...
TypedThreadSafeFunction<ContextType, DataType, CallJs>::New(
  ...
  napi_status status = napi_create_threadsafe_function(
      ...
      details::DefaultCallbackWrapper<
          CallbackType, TypedThreadSafeFunction<ContextType, DataType, CallJs>>(
          env, callback),
      resource, String::From(env, resourceName), maxQueueSize,
      initialThreadCount, finalizeData,
      details::ThreadSafeFinalize<ContextType, Finalizer, FinalizerDataType>::
          FinalizeFinalizeWrapperWithDataAndContext,
      context, CallJsInternal, &tsfn._tsfn);
...
template <typename ContextType, typename DataType,
          void (*CallJs)(Napi::Env, Napi::Function, ContextType*, DataType*)>
inline TypedThreadSafeFunction<
    ContextType, DataType, CallJs>::operator napi_threadsafe_function() const {
  return _tsfn;
}
...
inline ThreadSafeFunction ThreadSafeFunction::New(
    napi_env env, const Function& callback, ResourceString resourceName,
    size_t maxQueueSize, size_t initialThreadCount, ContextType* context) {
  return New(env, callback, Object(), resourceName, maxQueueSize,
...
inline ThreadSafeFunction ThreadSafeFunction::New(
    napi_env env, const Function& callback, ResourceString resourceName,
    size_t maxQueueSize, size_t initialThreadCount, Finalizer finalizeCallback,
    FinalizerDataType* data) {
  return New(env, callback, Object(), resourceName, maxQueueSize,
...
inline ThreadSafeFunction ThreadSafeFunction::New(
  ...
  return New(
      ...
      static_cast<void*>(nullptr) /* context */, finalizeCallback, data,
      details::ThreadSafeFinalize<void, Finalizer,
                                  FinalizerDataType>::FinalizeWrapperWithData);
}
...
inline ThreadSafeFunction ThreadSafeFunction::New(
    napi_env env, const Function& callback, const Object& resource,
    ResourceString resourceName, size_t maxQueueSize, size_t initialThreadCount,
    ContextType* context, Finalizer finalizeCallback) {
  return New(
      env, callback, resource, resourceName, maxQueueSize, initialThreadCount,
      context, finalizeCallback, static_cast<void*>(nullptr) /* data */,
...
inline ThreadSafeFunction::ConvertibleContext ThreadSafeFunction::GetContext()
  ...
  void* context;
  napi_status status = napi_get_threadsafe_function_context(_tsfn, &context);
  NAPI_FATAL_IF_FAILED(status, "ThreadSafeFunction::GetContext",
                       "napi_get_threadsafe_function_context");
...
inline ThreadSafeFunction ThreadSafeFunction::New(
  ...
  napi_status status = napi_create_threadsafe_function(
      ...
      initialThreadCount, finalizeData, wrapper, context, CallJS, &tsfn._tsfn);
  if (status != napi_ok) {
    delete finalizeData;
...
// static
inline void ThreadSafeFunction::CallJS(napi_env env, napi_value jsCallback,
...
inline AsyncProgressWorkerBase<DataType>::AsyncProgressWorkerBase(
    ...
    const Object& resource, size_t queue_size)
  ...
  _tsfn = ThreadSafeFunction::New(
      callback.Env(), callback, resource, resource_name, queue_size,
      /** initialThreadCount */ 1,
      /** context */ this, OnThreadSafeFunctionFinalize,
      /** finalizeData */ this);
}
...
inline AsyncProgressWorkerBase<DataType>::AsyncProgressWorkerBase(
  ...
  // ThreadSafeFunction::New signatures.
  _tsfn = ThreadSafeFunction::New(
      env, callback, resource, resource_name, queue_size,
      /** initialThreadCount */ 1,
      /** context */ this, OnThreadSafeFunctionFinalize,
      /** finalizeData */ this);
}
...
inline AsyncProgressWorker<T>::AsyncProgressWorker(const Function& callback,
                                                   const char* resource_name)
    : AsyncProgressWorker(callback, resource_name,
                          Object::New(callback.Env())) {}
...
inline AsyncProgressWorker<T>::AsyncProgressWorker(const Function& callback,
                                                   const char* resource_name,
                                                   const Object& resource)
    : AsyncProgressWorker(Object::New(callback.Env()), callback, resource_name,
                          resource) {}
...
inline AsyncProgressWorker<T>::AsyncProgressWorker(const Object& receiver,
                                                   const Function& callback,
                                                   const char* resource_name)
    : AsyncProgressWorker(receiver, callback, resource_name,
                          Object::New(callback.Env())) {}
...
inline AsyncProgressQueueWorker<T>::AsyncProgressQueueWorker(
    ...
    : AsyncProgressQueueWorker(callback, resource_name,
                               Object::New(callback.Env())) {}

template <class T>
inline AsyncProgressQueueWorker<T>::AsyncProgressQueueWorker(
    const Function& callback, const char* resource_name, const Object& resource)
    : AsyncProgressQueueWorker(Object::New(callback.Env()), callback,
...
inline AsyncProgressQueueWorker<T>::AsyncProgressQueueWorker(
    const Object& receiver, const Function& callback, const char* resource_name)
    : AsyncProgressQueueWorker(receiver, callback, resource_name,
                               Object::New(callback.Env())) {}
...
inline AsyncProgressQueueWorker<T>::AsyncProgressQueueWorker(
    ...
    : AsyncProgressWorkerBase<std::pair<T*, size_t>>(
          receiver, callback, resource_name, resource,
