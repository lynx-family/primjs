#ifndef WEAK_NODE_API_SRC_JS_NATIVE_API_H_
#define WEAK_NODE_API_SRC_JS_NATIVE_API_H_
...
NAPI_EXTERN napi_status NAPI_CDECL napi_wrap(
    ...
    node_api_basic_finalize finalize_cb, void* finalize_hint, napi_ref* result);
...
// Instance data
NAPI_EXTERN napi_status NAPI_CDECL
napi_set_instance_data(node_api_basic_env env, void* data,
