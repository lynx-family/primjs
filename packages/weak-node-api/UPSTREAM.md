...
- Source-based integration:
  ...
  - Use the provided scaffolding templates to generate an addon project that links the platform library from cloud artifacts when needed (Android/HarmonyOS).
